...
Original file is located at
    https://colab.research.google.com/github/estrellaxyx/Curso2022-2023-ODKG/blob/master/Assignment4/course_materials/notebooks/Task06.ipynb
...
# TO DO
jsURI = ns.JaneSmith
g.add((jsURI,RDF.type, ns.Researcher))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
